  ...
  return (
    <div className="min-h-screen text-white overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-b from-slate-800 via-blue-950 via-slate-900 via-blue-900 via-slate-900 to-slate-900" />
      </div>
            ...
            <div className="space-y-8 animate-fade-in-up mt-10 lg:mt-0">
              ...
              <div className="flex items-center space-x-8 pt-6">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-slate-400">+10 anos</span>
                </div>
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className={`absolute -inset-0.5 bg-gradient-to-r ${service.gradient} rounded-lg blur opacity-0 group-hover:opacity-20 transition-opacity duration-500`}
                ></div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-slate-300 leading-relaxed mb-8">
                  ...
                  <span className="text-blue-300 font-semibold">Gree</span>,{' '}
                  <span className="text-green-300 font-semibold">Elgin</span> e{' '}
                  <span className="text-orange-300 font-semibold">TCL</span>.
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <div
                  className={`absolute -inset-0.5 bg-gradient-to-r ${contact.gradient} rounded-lg blur opacity-0 group-hover:opacity-20 transition-opacity duration-500`}
                ></div>
